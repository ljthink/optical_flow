...
const STRU_PARAM global_params = {
	...
	FULL_IMAGE_ROW_SIZE,//PARAM_IMAGE_WIDTH
	FULL_IMAGE_COLUMN_SIZE,//PARAM_IMAGE_HEIGHT
	0,//PARAM_MAX_FLOW_PIXEL
	0,//PARAM_IMAGE_LOW_LIGHT
	0,//PARAM_IMAGE_ROW_NOISE_CORR
...
void mt9v034_set_context(uint8_t context);
...
void MT9V034_HW_DCMI_Init(void) 
{
  ...
  GPIO_Init(GPIOE, &GPIO_InitStructure);
	...
	*/
	...
	CROP_InitStructure.DCMI_VerticalLineCount = IMAGE_HEIGHT - 1;
	CROP_InitStructure.DCMI_CaptureCount = BYTES_PER_PIXEL*IMAGE_WIDTH - 1;
